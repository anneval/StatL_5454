...
In the following we perform best subset selection (of wage \~ age + age_sq + education) to determine a suitable model. To do this we use again the \textit{leaps} package in R. Below are the summary and the plot comparing RSS and the subset size k. According to the AIC the best sub model is model 4.
...
variable_data <- data.frame(
  ...
  ortho = c(aic_ortho_poly, bic_ortho_poly),
  row.names = c("AIC", "BIC")
)
