...
gg_acc <- ggplot(df, aes(x = Epoch)) +
  ...
  ggsave(filename = paste0("gg_loss_", dictionary, ".png"), plot = gg_loss 
         + theme(plot.background = element_rect(fill = "white")))
  ggsave(filename = paste0("gg_acc_", dictionary, ".png"), plot = gg_acc
         + theme(plot.background = element_rect(fill = "white")))
  
 # Save base R plots
  png(filename = paste0("p_fitted_", dictionary, ".png"))
  p_fitted
  dev.off()
  
  png(filename = paste0("p_fittedtest_", dictionary, ".png"))
  p_fittedtest
  dev.off()
  
  #objects_to_keep <- c("gg_loss", "gg_acc","df","p_fittedtest","p_fitted")
#rm(list = setdiff(ls(), objects_to_keep))

  # Save data frame
  save(df, file = paste0("df_", dictionary, ".RData"))
